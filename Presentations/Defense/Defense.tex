...
\begin{itemize}
\item Due to the low cross sections must create my own Monte Carlo Samples for the Signal
...
\item Major backgrounds: $t\bar{t}$, W+Jets, and processes with an associated photon
