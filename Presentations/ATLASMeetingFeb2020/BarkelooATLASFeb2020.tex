...
\begin{column}{0.48\textwidth}
\begin{itemize}
\item Before Fake Rate SFs
\end{itemize}
\includegraphics[width=.95\textwidth]{Images/PreSel_NNejet.png}
\end{column}
\begin{column}{0.48\textwidth}
\begin{itemize}
\item With Fake Rate SFs
\end{itemize}
\includegraphics[width=.95\textwidth]{Images/PreSelWithDD/PreSel_NNejet.png}
\end{column}
\end{columns}
}
...
\frame{\frametitle{Asimov Data Post-Fit}
\begin{columns}
...
\begin{itemize}
\item Fake rates calculated
\item Full systematics samples almost done, one major sample being run locally
\item Fitting machinery in place
\item Internal note draft started, complete first draft expected by end of February 
\begin{itemize}
\item Will be hosted here: \href{https://gitlab.cern.ch/jbarkelo/fcnc-tqgam-decay-intnote/blob/master/FCNCtqaINT.pdf}{gitlab:fcnc-tqgam-decay-intnote}
\end{itemize}
\item New post-doc joining the project to help push toward publication either alone or in combination with production mode
\end{itemize}
}
...
\frame{\frametitle{Asimov Data Pre-Fit}
\begin{columns}
\begin{column}{0.33\textwidth}
\begin{itemize}
\item VR1, W+$\gamma$
\end{itemize}
\includegraphics[width=.95\textwidth]{Images/FCNC_All_ejets/Plots/VR1_mqph.png} \\
\end{column}
\begin{column}{0.33\textwidth}
\begin{itemize}
\item VR2:  $t\bar{t}+\gamma$
\end{itemize}
\includegraphics[width=.95\textwidth]{Images/FCNC_All_ejets/Plots/VR2_mqph.png} \\
\end{column}
\begin{column}{0.33\textwidth}
\begin{itemize}
\item Signal Region
\end{itemize}
\includegraphics[width=.95\textwidth]{Images/FCNC_All_ejets/Plots/SR_mqph.png}
\end{column}
