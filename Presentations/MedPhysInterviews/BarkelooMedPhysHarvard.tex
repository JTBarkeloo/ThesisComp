...
\begin{itemize}
\item Regions to check background modeling behavior compared with data while not unblinding the signal region are used
\end{itemize}
\begin{columns}
...
\includegraphics[width=\textwidth]{Images/FCNC_All_ejetsPreSelFitFactors/Plots/PreSel_NNejet.png}\\
\end{column}
\end{columns}
}
...
\item Any excess in signal data events it is a strong indication of physics beyond the Standard Model
