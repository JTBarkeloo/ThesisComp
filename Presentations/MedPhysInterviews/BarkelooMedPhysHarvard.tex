...
\begin{itemize}
\item Newest Addition: Higgs Boson - 2012
\item
\end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
\centering
\includegraphics[width=\textwidth]{../../Thesis/ThesisImages/SMParticles.png}
\end{column}
\end{columns}
}
...
\item Collides protons at $\sqrt{\text{s}}=$ 13TeV
\item Over 11 Quadrillion events produced within the ATLAS detector so far
\end{itemize}
}
...
\centering
\includegraphics[width=.5\textwidth]{../../Thesis/ThesisImages/Simulation/ParticleInteractions.jpg}
}

\subsection{Picking Through The Data}
\section{Search For Ultra Rare Decays}
\subsection{Problems with the Standard Model}
\frame{\frametitle{Standard Model Problems}
}
...
\frame{\frametitle{Initial Output Plots}
\begin{columns}
\begin{column}{0.35\textwidth}
\begin{itemize}
\item Validation Region 1
\end{itemize}
\includegraphics[width=.95\textwidth]{Images/SystwoSyst/Plots/VR1_mqph.png} \\
\end{column}
\begin{column}{0.35\textwidth}
\begin{itemize}
\item Validation Region 2
\end{itemize}
...
\frame{\frametitle{Particles in ATLAS}
\centering
\includegraphics[width=.7\textwidth]{../../Thesis/ThesisImages/LHCImages/2012_highPileup.png}
}
