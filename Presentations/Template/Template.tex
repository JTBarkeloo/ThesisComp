...
\usepackage{graphicx}
\begin{document}
\title{Initial NN Studies for SiD}
...
\begin{itemize}
\item 10,000 Events (9,000 training, 1,000 validation)
\item No Prescaling (Unneccessary for regression networks?) - Explore
\item Truth Leakage = sum layers 41-60
\item Including first n layers, model attempts to calculate leakage
\item 40 Models made (Layer 1, Layers 1 and 2, etc.)
\end{itemize}
Python Code (very ugly, sorry) on Indico Page for this meeting as well (need keras installed)
Also at this git repository: https://github.com/JTBarkeloo/SiD-Neural-Network
}
\frame{\frametitle{Hyperparameters}
\begin{itemize}
\item Keras on top of TensorFlow is used
\item 3 Hidden Layers, 20 Nodes/Layer + 1 Bias node/Layer
\item 4,000 epochs, EarlyStopping: patience =200
\item batchsize = 10
\item Activation: ReLU on Input/Hidden Layers, Linear on Output Layer
\item Loss: logcosh, less forgiving with large outliers than mean squared errors
\end{itemize}
}

\frame{\frametitle{Including Front Layers 1,2,3,4 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/1FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/3FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/2FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/4FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 5,6,7,8 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/5FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/7FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/6FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/8FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 9,10,11,12 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/9FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/11FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/10FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/12FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 13,14,15,16 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/13FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/15FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/14FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/16FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 17,18,19,20 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/17FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/19FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/18FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/20FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 21,22,23,24 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/21FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/23FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/22FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/24FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 25,26,27,28 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/25FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/27FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/26FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/28FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 29,30,31,32 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/29FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/31FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/30FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/32FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 33,34,35,36 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/33FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/35FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/34FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/36FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}

\frame{\frametitle{Including Front Layers 37,38,39,40 }
\begin{columns}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/37FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/39FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/38FrontLayersLeakageFrontEnergy}.png} \\
\includegraphics[width=1.\textwidth]{{/home/jason/Desktop/inTransit/SidGarbage/AllFront/comp/40FrontLayersLeakageFrontEnergy}.png} 
\end{column}
\end{columns}
}
