...
\begin{center}
\includegraphics[width=.8\textwidth]{../../Thesis/ThesisImages/Simulation/BTagMV2c10andRejVsEff.png}\\
...
%%%%%%%%%%%%%%%%
\section{$e\rightarrow \gamma$ Fake Rate: Studies}
...
\section{$j\rightarrow \gamma$ Fake Rate Studies}
\subsection{$j\rightarrow \gamma$ Fake Rate Studies}
