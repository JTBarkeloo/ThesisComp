...
Muon Channel        & $1.64 \pm 0.80$   &   $2.27 \pm 0.41$\\ \hline %Change Put in post fit values
\end{tabular}
}
\end{center}
\end{table}
...
\frame{\frametitle{No Photon Region Scale Factors Applied in Validation Region}
\begin{columns}
\begin{column}{0.32\textwidth}
