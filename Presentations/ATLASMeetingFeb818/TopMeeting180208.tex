...
\frame{\frametitle{Thinning Out Backgrounds: Preselection Objects}
...
\item  Leading Jet $p_T$
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/el_h_leadJet_pt.png} \\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/mu_h_leadJet_pt.png}
\end{column}
\begin{column}{0.33\textwidth}
\begin{itemize}
\item Photons
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/el_h_photon_e.png} \\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/mu_h_photon_e.png}
\end{column}
\begin{column}{0.33\textwidth}
\begin{itemize}
\item Leptons
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/el_h_lepton_pt.png}\\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/mu_h_lepton_pt.png}
\end{column}
\end{columns}
}
...
\frame{\frametitle{Current Investigation: $\chi^2$ $\mu$-Channel }
...
\frame{\frametitle{Current Investigation: $\gamma$ Geometry}
...
\item e-channel
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsloose/el_h_photon_costheta.png} \\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/el_h_photon_costheta.png}
\end{column}
\begin{column}{0.4\textwidth}
\begin{itemize}
\item $\mu$-channel
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsloose/mu_h_photon_costheta.png} \\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/mu_h_photon_costheta.png}
\end{column}
%\begin{column}{0.33\textwidth}
%\begin{itemize}
...
\begin{column}{0.4\textwidth}
\begin{itemize}
\item $\Delta R_{\gamma closejet}$
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsloose/el_h_ph_drclosejet.png} \\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/el_h_ph_drclosejet.png}
\end{column}
%\begin{column}{0.33\textwidth}
%\begin{itemize}
%\item $\Delta R_{\gamma j_1}$
...
\frame{\frametitle{Current Investigation: H$_T$ and H$_T$+MET e-channel}
...
\item H$_T$
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsloose/el_h_HT.png} \\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/el_h_HT.png}
\end{column}
\begin{column}{0.4\textwidth}
\begin{itemize}
\item H$_T$ + MET
\end{itemize}
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsloose/el_h_HT_met.png} \\
\includegraphics[width=1.1\textwidth]{../../ThesisImages/plotsstrict/el_h_HT_met.png}
\end{column}
%\begin{column}{0.33\textwidth}
%\begin{itemize}
%\item $\Delta R_{\gamma j_1}$
...
\item Inclusion of a new term in $\chi^2$ to do with FCNC Top
\item Isolation cuts, Photon position don't seem too promising for background reduction
\item $\Delta R_{\gamma l}$ looks to be useful
\end{itemize}
\item Many cuts being optomized currently
\end{itemize}
...
\begin{itemize}
\item Barring any excess: with $\approx 150 \text{fb}^{-1}$ data at $\sqrt{s}=$ 13TeV setting an upper limit of  $\text{BR}(t\rightarrow q \gamma) <  3x10^{-5}$ is the goal, using a simple extrapolation from previous results. 
\item Orthogonal validation/control regions are in development
\item Next grid run will include data to look at MC modeling in these orthogonal regions
\item Need to request R21 version of MC
\end{itemize}
}
