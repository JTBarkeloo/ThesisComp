...
\begin{description}
\item[\textbf{Cross Section}:]  Just a test to show the paragraph formatting for this section Just a test to show the paragraph formatting for this section Just a test to show the paragraph formatting for this section
...
\begin{description}
\item[\textbf{Luminosity}:]  The uncertainty assessed to the total integrated luminosity is $\pm$2\% following a methodology outlined in Ref. \cite{ATLAS:2019pzw} from a preliminary calibration of the luminosity scale using x-y beam separation scans.
