...
\begin{figure}[h!]
	...
	\caption{Luminosity-weighted distribution of the mean number of interactions per bunch crossing for the entirety of Run 2 shown by individual years (2015-2018) as well as an integrated total (blue).
	}
