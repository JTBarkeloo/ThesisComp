...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=.8\columnwidth]{../ThesisImages/LHCImages/28VertexPileup.png}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=.8\columnwidth]{../ThesisImages/LHCImages/65VertexPileup.png}
