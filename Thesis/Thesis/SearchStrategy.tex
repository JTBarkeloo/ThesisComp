...
\begin{figure}[!htb]
\centering
\subfloat[Probe: Electrons]{\includegraphics[width=.5\columnwidth]{../ThesisImages/SearchStrategy/FakeRates/2dEEptDa.png}} \\
...
\begin{figure}[!htb]
\centering
\subfloat[Probe: Electrons]{\includegraphics[width=.5\columnwidth]{../ThesisImages/SearchStrategy/FakeRates/2dEEptMC.png}}\\
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.4\columnwidth]{../ThesisImages/SearchStrategy/ABCDpictoral.png}
