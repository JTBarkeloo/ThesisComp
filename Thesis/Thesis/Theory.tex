...
All four the neutral boson mediated FCNC channelss can be searched for individually and model independentally.  Each channel will have its own signature and various advantages and disadvantages in preforming the search.  Each of the diagrams is shown in Figure \ref{fig:AllFCNCs}
...
\begin{figure}[h!]
	...
	\label{fig:AllFCNCs}
\end{figure}
%Theories that address naturalness issues in the Standard Model generally have non-trivial flavor structure
